...
7. **Other harmful conduct.** Behaving in other ways that threaten the
...
available messages, logs, and other evidence, or by speaking with witnesses and
participants. Maintainers will keep investigations and enforcement actions as
...
following enforcement ladder may be used. Depending on the severity of a
violation, lower rungs may be skipped.

1. **Warning**
   - **Event:** A violation involving a single incident or series of incidents.
   - **Consequence:** A private, written warning from the maintainers.
   - **Repair:** A private written apology, acknowledgement of responsibility,
     or clarification of expectations may be requested.
2. **Temporarily Limited Activities**
   - **Event:** A repeated violation that previously resulted in a warning, or
     the first occurrence of a more serious violation.
   - **Consequence:** A private, written warning with a time-limited cooldown
     period or restrictions on particular community interactions.
   - **Repair:** An apology, reflection during the cooldown period, and a
     thoughtful return to community spaces may be requested.
3. **Temporary Suspension**
   - **Event:** A pattern of repeated violations that warnings have not
     resolved, or a single serious violation.
   - **Consequence:** A temporary suspension with written conditions for
     return.
   - **Repair:** Respecting the suspension, meeting the specified conditions,
     and thoughtfully reintegrating into the community.
4. **Permanent Ban**
   - **Event:** A pattern of violations that other steps have failed to
     resolve, or a violation so serious that community safety cannot otherwise
     be maintained.
   - **Consequence:** Access to community spaces, tools, and communication
     channels is permanently removed.
   - **Repair:** There is no possible repair in cases of this severity.

This enforcement ladder is a guideline. It does not limit the maintainers'
ability to use their discretion and judgment in the best interests of the
community.

## Scope

This Code of Conduct applies within all project community spaces and when an
individual is officially representing the project in public or other spaces.
Examples include using an official project account, posting through an official
